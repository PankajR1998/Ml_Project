...
class DataIngestionConfig:
    ...
    raw_data_path: str = os.path.join("artifect",'data.csv')
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        logging.info("Enter into the Data Ingestion method or Component.")
        try:
...
if __name__=="__main__":
    obj = DataIngestion()
    raw_path,train_path,test_path=obj.initiate_data_ingestion()
